...
###Set succesful returns colour
  ...
  # plt.pause(0.5)
  # plt.close()
  file_name='BT1-0_figures/figure{}.png'.format(trade)
...
model = tf.keras.models.load_model('saved_model/BT1-0_model')
...
plt.title('BT-PnL using RNN 1 or 0 prediction (threshold)')
plt.show()
