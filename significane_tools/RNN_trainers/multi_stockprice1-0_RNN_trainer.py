...
df['BT Close'] = df['Close']
df['VOD Close'] =  df['B_Close'] 
df['TEF Close']  = df['C_Close']

features_considered = ['signal','BT Close','VOD Close','TEF Close']
...
model.save('saved_model/TEL_multi1-0_model')
