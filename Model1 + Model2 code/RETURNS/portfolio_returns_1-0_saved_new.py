...
print("start training date {}".format(tar_data.iloc[[0]].index))
print("End training date {}".format(tar_data.iloc[[TRAIN_SPLIT]].index))
print("start testing date {}".format(tar_data.iloc[[TRAIN_SPLIT+1]].index))
print("end testing date {}".format(tar_data.iloc[[TRAIN_SPLIT+3001]].index))
...
# data_table = create_table(A_prices_data,B_prices_data,C_prices_data)
# data_table.plot(subplots=True)
#

# plt.show()
# print_cov(data_table)
#
